...
return conn.sendButton(m.chat, wm, author, rant, [['To Sticker', '.s']], m)
}
...
*like:* ${tek.like}
`
return conn.sendButton(m.chat, cap, author, tek.media, [['To Sticker', '.s']], m)
}
...
handler.command = handler.help = ['xhentai', 'xstyletext', 'xringtone', 'xumma', 'xquotesnime', 'xwikimedia', 'xwallpaper', 'xpinterest', 'xaiovideodl', 'apakah2', 'turu', 'tikporntok', 'turnbackhoax']
